...
import cn.mykine.userbehavior.bean.pojo.SensorReading;
...
public class FlinkKafka2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("bootstrap.servers", "192.168.10.135:9092,192.168.10.136:9092,192.168.10.137:9092");
        properties.setProperty("group.id", "flinkKafka2");
